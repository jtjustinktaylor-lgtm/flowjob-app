...
const Discounts = {
  ...
  edit(id) {
    ...
    App.openModal(`<div class="modal-header"><h3>Edit Discount</h3><button class="modal-close" onclick="App.closeModal()">✕</button></div>
      <div class="form-group"><label>Name</label><input class="form-control" id="df-name" value="${App.esc(d.name)}"></div>
      <div class="form-group"><label>Type</label>
        <select class="form-control" id="df-type">
      ...
      <div class="form-group"><label>Applies To</label><input class="form-control" id="df-applies" value="${App.esc(d.appliesTo||'')}"></div>
