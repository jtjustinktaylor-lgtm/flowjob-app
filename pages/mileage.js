...
const Mileage = {
  ...
  _getRate() {
    return parseFloat(App.state.mileageRate) || 0.70;
  },
  ...
  exportCSV() {
    ...
    App.downloadCSV(rows, 'flowjob-mileage-' + App.today() + '.csv');
  ...
  printReport() {
    ...
    App.printSection(`
      ...
      <div style="margin-top:32px;font-size:11px;color:#999;text-align:center">Generated ${App.formatDate(App.today())} — FlowJob Business Manager</div>
